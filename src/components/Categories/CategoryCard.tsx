...
const CategoryCard: FC<CategoryCardProps> = ({ image, name }) => {
  return (
    <div className="flex flex-col items-center justify-center gap-x-4 relative group">
      ...
      <div className="absolute h-1 bg-primary-lm bottom-[-5px] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200 ease-in-out w-full rounded">
      </div>
    </div>
  );
};
